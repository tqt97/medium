...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/tuantq/laravel/medium/public/storage' => 'string',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/tuantq/laravel/medium/public/storage',
...
'broadcasting.connections.ably.key','broadcasting.connections.log.driver','broadcasting.connections.null.driver','media-library.disk_name','media-library.max_file_size',
...
'debugbar.queries.explain','home','dashboard','profile.edit',
...
'password.update','logout','admin.posts.create','admin.posts.store','admin.posts.edit',
'admin.posts.update','admin.posts.destroy','storage.local',);
        registerArgumentsSet('views', 
'admin.posts.edit','admin.posts.form','auth.confirm-password','auth.forgot-password','auth.login',
'auth.register','auth.reset-password','auth.verify-email','components.application-logo','components.auth-session-status',
'components.category-tabs','components.danger-button','components.dropdown','components.dropdown-link','components.input-error',
'components.input-label','components.input-textarea','components.modal','components.nav-link','components.posts.item',
